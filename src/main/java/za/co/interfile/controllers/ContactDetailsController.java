...
import za.co.interfile.ejb.ContactDetailsFacade;
...
@Named("contactDetailsController")
@SessionScoped
public class ContactDetailsController implements Serializable {
    ...
    @EJB
    private za.co.interfile.ejb.ContactDetailsFacade ejbFacade;
    ...
    public ContactDetails getContactDetails(java.lang.Integer id) {
    ...
    public static class ContactDetailsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getContactDetails(getKey(value));
        }
